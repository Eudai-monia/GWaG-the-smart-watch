...
Page({
    ...
    tapit(){
        ...
        var judge=true
        var that=this
        this.data.numlist[temp]=Math.floor(Math.random()*10)
        for(temp=1;temp<5;temp++)
        {
            ...
            this.data.numlist[temp]=num 
        }
         for(temp=0;temp<5;temp++)
        {
            app.globalData.newlist[temp]=[this.data.itemList[this.data.numlist[temp]],[this.data.numlist[temp]]]
        }
